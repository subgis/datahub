...
import EditTagTermsField from './AddTagsField';
import { Entity, OperationType, EntityType } from '../../../../types.generated';
...
interface TagTermGroupProps extends CommonFieldProps {
    type?: EntityType;
...
function TagsField({ field, removeMargin, type }: TagTermGroupProps) {
    return (
        <StyledFormItem
...
function FormField(props: Props) {
    ...
    if (field.type === FieldType.TAGS) return (
        <TagsField field={field} removeMargin={removeMargin} />
    );
