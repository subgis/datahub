...
import { message, Select, Typography, Tag as CustomTag } from 'antd';
import styled from 'styled-components';

import { useGetSearchResultsLazyQuery } from '../../../../graphql/search.generated';
import { EntityType, Tag, Entity, ResourceRefInput } from '../../../../types.generated';
import CreateTagModal from '../../../shared/tags/CreateTagModal';
import {
...
export default function EditTagTermsField({
    type = EntityType.Tag,
            ...
            [
                {
                    ...
                    //subResource: entitySubresource, //add use case as subresource when ready, see subREsoruce type def.
    ...
    if (
        ...
        type === EntityType.Tag
        //urns.length === 0  // allow creating tags even if there are already tags selected
    ) {
    ...
    return (
            <ClickOutside onClickOutside={() => setIsFocusedOnInput(false)}>
                ...
                <BrowserWrapper isHidden={!isShowingGlossaryBrowser}> {/* use to display glossary maps instead */}
